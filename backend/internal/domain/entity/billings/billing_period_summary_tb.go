...
type BillingPeriodSummary struct {
	...
	TotalCommissionAmount decimal.Decimal `xorm:"decimal(12, 2) 'total_commission_amount' comment('周期总抽成金额') notnull default 0.00 " json:"total_commission_amount"` // 周期总抽成金额
	PendingAmount         decimal.Decimal `xorm:"decimal(12, 2) 'pending_amount' comment('待付金额') notnull default 0.00 " json:"pending_amount"`                      // 待付金额
	PaidAmount            decimal.Decimal `xorm:"decimal(12, 2) 'paid_amount' comment('已付金额') notnull default 0.00 " json:"paid_amount"`                            // 已付金额
	ErrorAmount           decimal.Decimal `xorm:"decimal(12, 2) 'error_amount' comment('失败金额') notnull default 0.00 " json:"error_amount"`                          // 失败金额
