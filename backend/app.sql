...
(
    ...
    `out_select_price`   decimal(12, 2) unsigned  default 0.00 not null comment '范围计算外适用金额',
    `out_select_tier`    decimal(12, 2) unsigned  default 0.00 not null comment '范围计算外适用百分比',
    `all_price_set`      decimal(12, 2)           default 0.00 not null comment '所有订单适用固定金额',
    `all_tiers_set`      decimal(12, 2)           default 0.00 not null comment '所有订单适用固定百分比',
