...
(
    ...
    `plans`             int(11)      NOT NULL DEFAULT 0 COMMENT 'app套餐id',
    ...
    `free_trial_days`   tinyint(4)   NOT NULL DEFAULT 0 COMMENT '试用天数',
...
(
    ...
    `product_id`   varchar(50)  NOT NULL DEFAULT '' COMMENT 'shopify上传成功的产品ID',
    ...
    `status`       tinyint(1)   NOT NULL DEFAULT 0 COMMENT '发布Shopify：0:未发布 1:已发布 2:正在发布中 3:shopify平台已删除',
...
(
    `id`              bigint(20)     NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `user_id`         bigint(20)     NOT NULL COMMENT '用户id',
    `user_product_id` bigint(20)     NOT NULL COMMENT '保险用户产品表ID',
    `product_id`      varchar(50)    NOT NULL DEFAULT '' COMMENT 'Shopify产品ID',
    `variant_id`      varchar(50)    NOT NULL DEFAULT '' COMMENT 'Shopify变体ID',
    `inventory_id`    varchar(50)    NOT NULL DEFAULT '' COMMENT 'Shopify仓库ID',
...
(
    ...
    `variant_id`        varchar(50)    NOT NULL DEFAULT '' COMMENT '变体ID',
...
(
    `id`          bigint(20)   NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `order_id`    varchar(50)  NOT NULL DEFAULT '' COMMENT 'shopify 订单id',
