...
(
    ...
    `redact_time`  bigint  NOT NULL COMMENT 'Redact处理时间',
...
(
    ...
    `trial_time`        bigint   NOT NULL DEFAULT 0 COMMENT '试用时间',
    ...
    `last_login`        bigint   NOT NULL DEFAULT 0 COMMENT '最后登录时间',
    `is_del`            tinyint   NOT NULL DEFAULT 0 COMMENT '删除状态 0正常 1已删除',
    `publish_id`        bigint NOT NULL DEFAULT 0 COMMENT '店铺publish_id',
    `install_time`      bigint   NOT NULL DEFAULT 0 COMMENT '安装时间',
    `uninstall_time`    bigint   NOT NULL DEFAULT 0 COMMENT '卸载时间',
    `create_time`       bigint   NOT NULL COMMENT '创建时间',
    `update_time`       bigint   NOT NULL COMMENT '最近修改时间',
    PRIMARY KEY (`id`),
...
(
    ...
    `product_id`   bigint  NOT NULL DEFAULT 0 COMMENT 'shopify上传成功的产品ID',
...
(
    `id`              bigint     NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `user_id`         bigint     NOT NULL COMMENT '用户id',
    `user_product_id` bigint     NOT NULL COMMENT '保险用户产品表ID',
    `product_id`      bigint  NOT NULL DEFAULT 0 COMMENT 'Shopify产品ID',
    `variant_id`      bigint  NOT NULL DEFAULT 0 COMMENT 'Shopify变体ID',
    `inventory_id`    bigint  NOT NULL DEFAULT 0 COMMENT 'Shopify仓库ID',
...
(
    `id`                  bigint     NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `user_id`             bigint     NOT NULL COMMENT '用户id',
    `order_id`            bigint  NOT NULL DEFAULT 0 COMMENT 'Shopify订单ID',
    `order_name`          varchar(50)    NOT NULL DEFAULT '' COMMENT '订单编号（#xxx）',
    `order_created_at`    bigint     NOT NULL DEFAULT 0 COMMENT '订单创建时间',
    `order_completion_at` bigint     NOT NULL DEFAULT 0 COMMENT '订单完成时间',
...
(
    `id`                bigint     NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `user_id`           bigint     NOT NULL COMMENT '用户id',
    `user_order_id`     bigint     NOT NULL COMMENT '主表ID',
    `sku`               varchar(100)   NOT NULL DEFAULT '' COMMENT 'SKU',
    `variant_id`        bigint  NOT NULL DEFAULT 0 COMMENT '变体ID',
...
(
    `id`          bigint     NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `user_id`     bigint     NOT NULL COMMENT '用户ID',
    `today`       bigint        NOT NULL DEFAULT 0 COMMENT '当天0点时间戳',
...
(
    `id`          bigint   NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `order_id`    bigint  NOT NULL DEFAULT 0 COMMENT 'shopify 订单id',
    `name`        varchar(100) NOT NULL DEFAULT '' COMMENT '店铺name',
    `job_time`    bigint   NOT NULL COMMENT '队列时间(毫秒时间戳)',
...
(
    `id`              bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `user_id`         bigint NOT NULL COMMENT '用户id',
    `user_product_id` bigint NOT NULL COMMENT '用户产品ID',
    `job_time`        bigint NOT NULL COMMENT '队列时间(毫秒时间戳)',
    `is_success`      tinyint NOT NULL DEFAULT 0 COMMENT '处理状态 0 未处理完成 1 处理成功',
    `create_time`     bigint NOT NULL COMMENT '创建时间',
    `update_time`     bigint NOT NULL COMMENT '修改时间',
...
(
    ...
    `token_expires_at` bigint   NOT NULL DEFAULT 0 COMMENT 'token过期时间',
