...
export const OrderFilters = ({
  ...
  const handleSortChange = useCallback(
    (sortValue: string[]) => {
      ...
      onSortChange(sortByValue as SortOption, direction as SortDirection);
    },
    [onSortChange]
  );
  ...
  const filters = [
    ...
    },
    {
      ...
      filter: <PaymentStatusFilter paymentStatus={paymentStatus} onPaymentStatusChange={onPaymentStatusChange} />,
      shortcut: true,
    },
    {
      key: "fulfillmentStatus",
