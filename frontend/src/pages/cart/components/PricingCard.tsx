      ...
      <BlockStack gap="400">
        ...
        {pricingSettings.pricingRule === "1" && (
          <PricingTable
            ...
            errors={errors}
            onPriceChange={(index, field, value, error) => onPricingChange(index, field, value, "price")}
            onTierChange={(index, field, value, error) => onPricingChange(index, field, value, "tier")}
